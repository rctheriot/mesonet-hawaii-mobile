...
export default function StationList({ stations, monitorData, onSelectStation, favorites, coords, requestLocation, geoLoading, geoError }: StationListProps) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-white dark:bg-slate-950">
      ...
      <div className="flex-shrink-0 border-b border-slate-100 dark:border-slate-800 px-3 pt-2 pb-2 space-y-2">
